/*
A class is the blueprint for creating objects, and the constructor is a special method that initializes those objects when they are created.
*/
...
class Developer {
  ...
  introduce() {
    console.log(
      `Hi, I'm ${this.name} and I specialize in ${this.skills.join(", ")}.`
    );
  }
  /* --------------------------------- */
